...
if(isset($_POST['submit'])) 
{
  ...
  $pass = $_POST['psw'];
    ...
    if($name == "" || $age == "" || $gender == "" || $location == "" || $contact == "" || $pass == "" || $email == "") 
    {
        echo "All fields should be filled. Either one or many fields are empty.";
    }
    else
    {
        $insert="INSERT INTO volunteerreg(Fullname,Age,Gender, Location, Contact, Email,Facebook, Password) 
        VALUES('$name', '$age','$gender','$location','$contact','$email','$facebook', md5('$pass'))";
    }
